        ...
        >
          ...
          <div className="flex items-center justify-between px-6 md:px-12 h-[72px] max-w-[2000px] mx-auto w-full">
            ...
            <div className="flex items-center gap-6 w-1/3">
              <button onClick={() => setIsMenuOpen(true)} className="bg-transparent border-none text-current p-1 cursor-pointer hover:opacity-70 transition-opacity">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1"><line x1="3" y1="12" x2="21" y2="12" /><line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="18" x2="21" y2="18" /></svg>
              </button>
            </div>

            {/* CENTER: Dedicated Logo Typography */}
            <div className="flex items-center justify-center w-1/3">
              <Link href="/" className="flex items-center justify-center no-underline gap-3">
                <span className="font-serif text-current text-2xl tracking-[0.25em] uppercase font-normal">ASUKĀ</span>
              </Link>
            </div>

            {/* RIGHT: Actions */}
            <div className="flex items-center justify-end gap-6 w-1/3">
              <Link href="/search" className="text-current p-1 hover:opacity-70 transition-opacity">
              ...
              <button type="button" className="bg-transparent border-none text-current p-1 cursor-pointer hidden sm:block hover:opacity-70 transition-opacity">
                {/* Account Icon */}
              ...
              <button type="button" className="bg-transparent border-none text-current p-1 cursor-pointer hover:opacity-70 transition-opacity relative">
                {/* Cart Icon */}
                ...
                <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-white text-black text-[9px] font-mono font-bold">
                  0
                </span>
              </button>
            </div>
